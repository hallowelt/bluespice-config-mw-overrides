...
*/
$GLOBALS['wgAutoloadClasses']['BsWebInstaller'] = dirname( __DIR__ ) . '/extensions/BlueSpiceFoundation/includes/installer/BsWebInstaller.php';
$GLOBALS['wgAutoloadClasses']['BsWebInstallerOutput'] = dirname( __DIR__ ) . '/extensions/BlueSpiceFoundation/includes/installer/BsWebInstallerOutput.php';
$GLOBALS['wgAutoloadClasses']['BsLocalSettingsGenerator'] = dirname( __DIR__ ) . '/extensions/BlueSpiceFoundation/includes/installer/BsLocalSettingsGenerator.php';
...
class InstallerOverrides {
	 ...
	 */
	public static function getLocalSettingsGenerator( Installer $installer ) {
		return new BsLocalSettingsGenerator( $installer );
	}
	...
	public static function getWebInstaller( WebRequest $request ) {
		return new BsWebInstaller( $request );
	}
